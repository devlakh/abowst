...
-- Dumping structure for table abowst.failed_jobs
...
-- Dumping structure for table abowst.journal_extras
CREATE TABLE IF NOT EXISTS `journal_extras` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `academic_work_id` bigint(20) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `journal_extras_academic_work_id_index` (`academic_work_id`),
  CONSTRAINT `journal_extras_academic_work_id_foreign` FOREIGN KEY (`academic_work_id`) REFERENCES `academic_works` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table abowst.migrations
...
-- Dumping structure for table abowst.password_resets
...
-- Dumping structure for table abowst.personal_access_tokens
...
-- Dumping structure for table abowst.users
